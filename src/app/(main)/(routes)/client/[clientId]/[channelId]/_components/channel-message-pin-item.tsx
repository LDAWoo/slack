...
import { ReactionWithMemberWithUser } from "@/lib/types";
...
const ChannelMessagePinItem = ({ id, user, reactions, member, body, isUpdated, deleted, createdAt, socketUrl, socketQuery, onClick }: ChannelMessagePinItemProps) => {
