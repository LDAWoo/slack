...
type ChannelProfileUserProps = {
    user: User;
    clientId: string;
};

const ChannelProfileUser = ({ user, clientId }: ChannelProfileUserProps) => {
                                ...
                                <>
                                    ...
                                    {isOwner && (
                                        <Hint content={"Clear status"} side="left">
                                            <Button className="w-[15px] h-[15px] rounded-full p-0" onClick={handleRemoveStatus}>
                                                <X size={10} />
                                            </Button>
                                        </Hint>
                                    )}
...
export default React.memo(ChannelProfileUser);
