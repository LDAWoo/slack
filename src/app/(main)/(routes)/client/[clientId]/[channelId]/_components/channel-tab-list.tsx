...
import ChannelTabOptions from "./channel-tab-options";
    ...
    return (
        <DragDropContext onDragEnd={onDragEnd}>
            <Droppable droppableId="droppable" direction="horizontal">
                {(provided, snapshot) => (
                    <div {...provided.droppableProps} ref={provided.innerRef} className="flex w-full gap-1 items-center">
                        ...
                        {!snapshot.isUsingPlaceholder && <ChannelTabOptions />}
...
export default React.memo(ChannelTabList);
