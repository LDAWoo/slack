...
const ChannelMessageItem = ({ id, socketUrl, socketQuery, user, message, reactions, pin, currentMember, member, body, isCompact, createdAt, isUpdated, deleted }: ChannelMessageItemProps) => {
