...
type StepPageOneProps = WorkspaceWithChannelAndMemberAndCanvas & {
    user: User;
};

const StepPageOne = ({ workspace, user }: StepPageOneProps) => {
    ...
    return (
        <div className="flex flex-col p-[64px] max-w-[705px]">
            ...
            <h1 className="!font-bold !text-[48px] mt-1 !leading-[46px]">What is your name?</h1>
