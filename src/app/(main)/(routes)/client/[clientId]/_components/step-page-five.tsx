...
type StepPageFiveProps = WorkspaceWithChannelAndMemberAndCanvas;

const StepPageFive = ({ workspace }: StepPageFiveProps) => {
    ...
    return (
        <div className="flex flex-col p-[64px]">
            ...
            <h1 className="!font-bold !text-[48px] mt-1 !leading-[46px]">Choose a package to get started:</h1>
...
export default React.memo(StepPageFive);
