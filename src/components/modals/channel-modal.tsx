...
import ChannelMembers from "./components/channel/channel-members";
...
const ChannelModal = () => {
    ...
    const { user, channel, workspace, defaultType } = data;
    ...
    return (
        <Dialog open={isModalOpen} onOpenChange={onClose}>
            <DialogContent className="w-[580px] max-w-[580px] bg-background gap-0 shadow-[0_2px_10px_0_hsl(0_calc(1_*_0%)_0%_/_0.2)] p-0 overflow-hidden border-0 !rounded-[6px]">
                ...
                <div className="p-0">
                    <Tabs defaultValue={defaultType || "members"}>
                        ...
                        <TabsContent value="members" className="p-[16px_0_0_0] mt-0">
                            <ChannelMembers members={members} member={member} userId={user.id} />
                        </TabsContent>
