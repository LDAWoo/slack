...
export const ParagraphIcon = ({ size, className }: Props) => {
    return (
        <svg data-315="true" data-qa="paragraph" aria-hidden="true" viewBox="0 0 20 20" width={size} height={size} className={cn(className)} fill="none">
            <path fill="currentColor" fillRule="evenodd" d="M7.25 3.007C5.42 3.109 4 4.335 4 6.25s1.42 3.14 3.25 3.243zm0 7.988C4.75 10.886 2.5 9.152 2.5 6.25c0-2.999 2.402-4.75 5-4.75h9.25a.75.75 0 0 1 0 1.5h-3v14.75a.75.75 0 0 1-1.5 0V3h-3.5v14.75a.75.75 0 0 1-1.5 0z" clipRule="evenodd"></path>
        </svg>
    );
};

export const Heading1 = ({ size, className }: Props) => {
    return (
        <svg data-315="true" data-qa="heading-1" aria-hidden="true" viewBox="0 0 20 20" width={size} height={size} className={cn(className)} fill="none">
            <path fill="currentColor" fillRule="evenodd" d="M3 3.25a.75.75 0 0 0-1.5 0v13.5a.75.75 0 0 0 1.5 0v-6h6.2v6a.75.75 0 0 0 1.5 0V3.25a.75.75 0 0 0-1.5 0v6H3zM17.45 8.5a.75.75 0 0 0-1.191-.607l-2.75 2a.75.75 0 1 0 .882 1.214l1.559-1.134v6.777a.75.75 0 0 0 1.5 0z" clipRule="evenodd"></path>
        </svg>
    );
};

export const Heading2 = ({ size, className }: Props) => {
    return (
        <svg data-315="true" data-qa="heading-2" aria-hidden="true" viewBox="0 0 20 20" width={size} height={size} className={cn(className)} fill="none">
            <path fill="currentColor" fillRule="evenodd" d="M2.25 2.5a.75.75 0 0 1 .75.75v6h6.2v-6a.75.75 0 0 1 1.5 0v13.5a.75.75 0 0 1-1.5 0v-6H3v6a.75.75 0 0 1-1.5 0V3.25a.75.75 0 0 1 .75-.75M14.952 16a59 59 0 0 1 1.49-1.526c.33-.33.613-.613.84-.86.345-.373.629-.73.815-1.15.192-.431.255-.87.255-1.372 0-.954-.347-1.726-.913-2.264a3.1 3.1 0 0 0-1.976-.824c-.696-.035-1.425.154-1.995.6-.59.462-.968 1.17-.968 2.053a.75.75 0 0 0 1.5 0c0-.421.165-.693.393-.871.245-.193.604-.303.996-.284.388.02.755.165 1.016.414.25.237.447.607.447 1.176 0 .37-.046.583-.126.763-.085.193-.237.407-.546.742-.207.224-.456.473-.77.787l-.545.547a59 59 0 0 0-2.176 2.32.748.748 0 0 0 .204 1.159c.106.057.228.09.357.09h4.352a.75.75 0 0 0 0-1.5z" clipRule="evenodd"></path>
        </svg>
    );
};

export const Heading3 = ({ size, className }: Props) => {
    return (
        <svg data-315="true" data-qa="heading-3" aria-hidden="true" viewBox="0 0 20 20" width={size} height={size} className={cn(className)} fill="none">
            <path fill="currentColor" fillRule="evenodd" d="M2.25 2.5a.75.75 0 0 1 .75.75v6h6.2v-6a.75.75 0 0 1 1.5 0v13.5a.75.75 0 0 1-1.5 0v-6H3v6a.75.75 0 0 1-1.5 0V3.25a.75.75 0 0 1 .75-.75m13.166 13.435c.848-.084 1.484-.636 1.484-1.526 0-.714-.259-1.143-.59-1.374-.342-.24-.895-.36-1.649-.174a.75.75 0 0 1-.73-1.249L15.929 9.5H12.95a.75.75 0 0 1 0-1.5h4.719a.75.75 0 0 1 .545 1.265l-1.994 2.11c.342.086.663.23.951.43.806.565 1.229 1.5 1.229 2.604 0 1.837-1.41 2.876-2.834 3.019-1.424.142-3.044-.576-3.628-2.327a.75.75 0 1 1 1.423-.475c.326.976 1.207 1.394 2.055 1.31" clipRule="evenodd"></path>
        </svg>
    );
};
...
export const CheckIcon = ({ size, className }: Props) => {
    return (
        <svg data-315="true" data-qa="menu_item_checkmark" aria-hidden="true" viewBox="0 0 20 20" width={size} height={size} className={cn(className)} fill="none">
            <path fill="currentColor" fillRule="evenodd" d="M17.234 3.677a.75.75 0 0 1 .089 1.057l-9.72 11.5a.75.75 0 0 1-1.19-.058L2.633 10.7a.75.75 0 0 1 1.234-.852l3.223 4.669 9.087-10.751a.75.75 0 0 1 1.057-.089" clipRule="evenodd"></path>
        </svg>
    );
};
...
export const EmojiPlus = ({ size, className }: Props) => {
    return (
        <svg data-2hw="true" data-qa="addReaction" aria-hidden="true" viewBox="0 0 20 20" width={size} height={size} className={cn(className)} fill="none">
...
export const CanvasIcon = ({ size, className }: Props) => {
    return (
        <svg data-ebo="true" data-qa="canvas-content" aria-hidden="true" viewBox="0 0 20 20" width={size} height={size} className={cn(className)} fill="none">
...
export const EmojiIcon = ({ size, className }: Props) => {
    return (
        <svg data-ebo="true" data-qa="emoji" aria-hidden="true" viewBox="0 0 20 20" width={size} height={size} className={cn(className)} fill="none">
